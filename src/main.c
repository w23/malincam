...
static int v4l2_open(const char *devname) {
	...
	const int fd = open(devname, O_RDWR | O_NONBLOCK);
	if (fd < 0) {
	...
	v4l2_enum_formats(fd, V4L2_BUF_TYPE_VIDEO_CAPTURE);
	v4l2_enum_formats(fd, V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE);
	v4l2_enum_formats(fd, V4L2_BUF_TYPE_VIDEO_OUTPUT);
	v4l2_enum_formats(fd, V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE);

	// TODO VIDIOC_ENUM_FRAMESIZES
	// TODO VIDIOC_ENUM_FRAMEINTERVALS

	v4l2_set_format(fd, V4L2_BUF_TYPE_VIDEO_CAPTURE, 1280, 720);
	v4l2_requestbuffers(fd, V4L2_BUF_TYPE_VIDEO_CAPTURE);

	//v4l2_set_format(fd, V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE, 1280, 720);
	//v4l2_requestbuffers(fd, V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE);
